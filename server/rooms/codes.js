/**
 * Room code generation: four characters from a 24-letter alphabet is ~330k combinations, small
 * enough that collision checking is mandatory. The prototype's check tested array indices and never
 * caught a collision (design-spec.md §9).
 */
